...
var splitMe = {
    ...
    update: function (element) {
        ...
        gNewPos = element.percent;

    },
    init: function () {
        splitMe.resizes = NodeListAsArray(document.querySelectorAll('.flex-container')).
            concat(NodeListAsArray(document.querySelectorAll('.horizontally_divided')));

        splitMe.resizes.forEach(function (elem) {

            var v = elem.hasClass('flex-container');
            elem.vertical = v;
